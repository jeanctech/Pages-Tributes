  ...
  return (
    <>
      <div id="app-aside" className="m-0 p-1 bg-slate-300 text-slate-800 flex flex-col ">
        <div id="aside_container" className="mx-10 px-10 m-2.5 p-2.5 bg-slate-400 flex flex-col items-center justify-center rounded-lg ">
            <img src={Images} width={300} id="aside-img" className="m-1 p-0 flex flex-col border-4 border-slate-500 rounded-lg items-start justify-start "></img>
        ...
        <div id="aside_container" className="m-1 p-1 bg-slate-400 flex flex-col items-start justify-start rounded-lg">
          ...
          <h3 id="aside_title" className="m-1 p-1 font-bold text-2xl flex flex-col items-start justify-start ">
            - Inicio
          </h3>
          <p className="m-1 p-1 flex flex-col items-start justify-start ">
